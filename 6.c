...
int main (){
	...
	do{
		...
		printf("\n            Aeropuerto Internacinal de Tocumen          ");
	...
	// Se hacen las converiones a dolar según la opción que haya escogido el cliente
		switch(menu){
			case 1: cantidadDolar = cantidad*BOLIVARVENEZOLANO;
			   printf("\n Su cantidad en dolar es de: %0.2f", cantidadDolar);
			break;
		   
			case 2: cantidadDolar = cantidad*DOLARCANADIENSE;
			   printf("\n Su cantidad en dolar es de: %0.2f", cantidadDolar);   
			break;  
		 
			case 3: cantidadDolar = cantidad*LIBRA;
			   printf("\n Su cantidad en dolar es de: %0.2f", cantidadDolar);
			break;  
		 		   
			case 4: cantidadDolar = cantidad*PESOCOLOMBIANO;
			   printf("\n Su cantidad en dolar es de: %0.2f", cantidadDolar);
			break;	   
				   
			case 5: cantidadDolar = cantidad*PESOMEXICANO;
			   printf("\n Su cantidad en dolar es de: %0.2f", cantidadDolar);
			break;	 
		  
			case 6: cantidadDolar = cantidad*YEN;
			   printf("\n Su cantidad en dolar es de: %0.2f", cantidadDolar);
			break;
			   		   
			case 7: cantidadDolar = cantidad*YUAN;
			   printf("\n Su cantidad en dolar es de: %0.2f", cantidadDolar);
			break;
		   		   
			case 8: cantidadDolar = cantidad*EURO;
			   printf("\n Su cantidad en dolar es de: %0.2f", cantidadDolar);
			break;
			   		   
			case 9: cantidadDolar = cantidad*REALBRASILENO;
			   printf("\n Su cantidad en dolar es de: %0.2f", cantidadDolar);
			break;
			   		   
			case 10: cantidadDolar = cantidad*PESOARGENTINO;
			   printf("\n Su cantidad en dolar es de: %0.2f", cantidadDolar);
			break;	   		   	   		   
			}		
